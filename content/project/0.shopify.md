...
stacks: ['react', 'remix-js', 'tailwindcss', 'nodejs']
...
I started the KiriminAja Shopify App project in November 2020 with my team. Our goal was to create a seamless logistics integration for Shopify merchants, enabling them to manage shipments directly from their store admin.
