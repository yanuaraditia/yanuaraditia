<template>
  <header class="sticky z-50 top-0 h-16 xl:h-20 transition-all" :class="[(isFixed || showNavbar ? 'bg-red-100 dark:bg-neutral-900 dark:xl:bg-opacity-90 xl:saturate-200 xl:backdrop-blur-2xl' : 'bg-transparent')]">
