  ...
  <header class="sticky z-50 top-0 h-16 transition-all" :class="[(isFixed || showNavbar ? 'bg-red-100' : 'bg-transparent')]">
    <div class="container xl:px-4 mx-auto xl:w-9/12">
      <div class="xl:flex">
        ...
        <div :class="[(showNavbar ? '' : '-translate-x-full xl:translate-x-0')]" class="px-4 transition-all duration-200 xl:px-0 xl:ml-auto bg-red-100 xl:bg-transparent border-y xl:border-y-0 border-y-red-200 xl:flex xl:gap-8 xl:place-items-center font-semibold xl:font-medium">
