<template>
  <div class="fixed w-screen h-screen overflow-hidden">
...
const props = withDefaults(defineProps<Props>(), {
  glitchColors: () => ['#202020', '#303030', '#404040'],
  glitchSpeed: 50,
...
const resizeCanvas = () => {
  ...
  const parentWidth =
    parent.parentElement?.offsetWidth || parent.offsetWidth || window.innerWidth
  const parentHeight =
